...
namespace MovieTheater.Infrastructure.Migrations
{
    ...
    [Migration("20221217000251_Add movie language to screening table 2")]
    partial class Addmovielanguagetoscreeningtable2
    {
            ...
            modelBuilder.Entity("MovieTheater.Domain.Entities.Screening", b =>
                {
                    ...
                    b.HasOne("MovieTheater.Domain.Entities.MovieLanguage", "MovieLanguage")
                        .WithMany("Screenings")
